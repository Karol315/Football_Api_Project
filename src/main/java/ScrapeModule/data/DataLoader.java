...
public class DataLoader {
    ...
    private static void performScrappingAndSave(LocalDateTime now) {
        ...
        CsvWriter.writeToCsv("database/ekstraklasa.csv", entries1);
        ...
        CsvWriter.writeToCsv("database/premier_league.csv", entries2);
        // LaLiga 2024/25
        ...
        CsvWriter.writeToCsv("database/laliga.csv", entries3);
        // Bundesliga 2024/25
        ...
        CsvWriter.writeToCsv("database/bundesliga.csv", entries4);
        // Serie A 2024/25
        ...
        ChampionsLeagueScrapeTable scrapeTable6 = new ChampionsLeagueScrapeTable(new JSoupConnection("https://www.eurosport.com/football/champions-league/standings.shtml"));
        List<Entry> entries6 = scrapeTable6.scrapeLeagueTable();
        CsvWriter.writeToCsv("database/champions_league.csv", entries6);
        // French League One 2024/25
        LeagueOneScrapeTable scrapeTable7 = new LeagueOneScrapeTable(new JSoupConnection("https://www.eurosport.com/football/ligue-1/2024-2025/standings.shtml"));
        List<Entry> entries7 = scrapeTable7.scrapeLeagueTable();
        CsvWriter.writeToCsv("database/league_one.csv", entries7);
