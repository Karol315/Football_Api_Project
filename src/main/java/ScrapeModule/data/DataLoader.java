...
//        CsvWriter.writeToCsv("laliga.csv", entries3);
        // Bundesliga 2024/25
//        BundesligaScrapeTable scrapeTable = new BundesligaScrapeTable(new JSoupConnection("https://www.bundesliga.com/en/bundesliga/table"));
//        List<Entry> entries4 = scrapeTable.scrapeLeagueTable();
...
//        SerieAScrapeTable scrapeTable = new SerieAScrapeTable(new JSoupConnection("https://www.legaseriea.it/en"));
